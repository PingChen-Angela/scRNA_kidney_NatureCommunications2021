...
## load input data
load(file = "SCENIC/data/kidney_human_data.rda")

# outdir
outdir = 'SCENIC/results/human'
setwd(outdir)
...
scenicOptions@fileNames$output["loomFile",] <- "output/human_SCENIC.loom"
