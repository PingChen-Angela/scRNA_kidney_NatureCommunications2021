...
## prepare input data
## load input data
load(file = "SCENIC/data/kidney_pdgfrb_mmu_data.rda")

# outdir
outdir = 'SCENIC/results/pdgfrb_mmu'
setwd(outdir)
...
colVars <- list(CellType=c("MES"="blue", 
                           "PEC"="orange",
                           "TubuleC"="brown",
                           "GEC"="magenta",
                           "MLC"="cyan"))
...
org = "mgi"
myDatasetTitle = "Pdgfrb+ mouse glom"
data(defaultDbNames)
...
scenicOptions@fileNames$output["loomFile",] <- "output/mouse_biased_SCENIC.loom"
